...
$("#searchBtn").click(function () {
  ...
  var inputVal = document.getElementById("userInput").value;
    localStorage.setItem('userDeets', inputVal);
    
  
  // Defining the local storage object so it may be called by the "saveMovie" button
  // const movieDeets = function(inputVal) {localStorage.setItem('inputVal', JSON.stringify)}
